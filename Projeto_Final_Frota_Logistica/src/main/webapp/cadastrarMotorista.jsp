...
<head>
<meta charset="UTF-8">
<title>Cadastrar Motorista - Logística Pro</title>
<link
...
.form-control:focus, .form-select:focus {
	border-color: #002d72;
	box-shadow: 0 0 0 0.25rem rgba(0, 45, 114, 0.1);
}
		...
		<div class="row justify-content-center">
			<div class="col-lg-10">
				...
				<div class="alert alert-danger shadow-sm"
					style="border-radius: 12px;"><%=erro%></div>
				<% } %>

				<div class="card card-form">
					<div class="card-header-custom">
						<span class="brand-logo-small">Cadastrar Motorista</span>
						<p class="text-muted">Insira os dados pessoais e de
							habilitação do condutor.</p>
					</div>
					<div class="p-3 px-lg-5 pb-5">
						<form id="formMotorista"
							action="<%=request.getContextPath()%>/SvCadastrarMotorista"
							method="post">
							...
							<div class="row g-3">
								<div class="col-md-8">
									<label>Nome Completo</label> <input class="form-control"
										name="nome" required placeholder="Digite o nome completo">
								</div>
								<div class="col-md-4">
								...
								<div class="col-md-6">
									<label>E-mail</label> <input type="email" class="form-control"
										name="email" placeholder="exemplo@email.com">
								</div>
								<div class="col-md-6">
									<label>Telefone/WhatsApp</label> <input class="form-control"
										name="telefone" required placeholder="(00) 00000-0000">
								</div>
							</div>

							<!-- documentos -->
							<div class="section-title">Habilitação (CNH)</div>
							<div class="row g-3">
								<div class="col-md-4">
									<label>Número da CNH</label> <input class="form-control"
										name="cnh" required>
								</div>
								<div class="col-md-4">
									<label>Categoria</label> <select class="form-select"
										name="categoriaCnh" required>
								...
								<div class="col-md-4">
									<label>Vencimento</label> <input type="date"
										class="form-control" name="vencimentoCnh" required>
								</div>
							</div>

							<!-- status -->
							<div class="section-title">Status e Endereço</div>
							<div class="row g-3">
								<div class="col-md-4">
									<label>Status</label> <select class="form-select" name="status"
										required>
								...
								<div class="col-md-8">
									<label>Endereço Residencial</label> <input class="form-control"
										name="endereco" placeholder="Rua, número, bairro e cidade">
								</div>
							</div>

							<!-- BOTÃO -->
							<button type="submit" class="btn-save" id="btnSalvar">
								<i class="bi bi-person-check me-2"></i> Confirmar Cadastro
							</button>
						</form>
					</div>
				</div>
